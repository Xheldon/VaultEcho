...
目录 B: /Users/x/Developer/obsidian-ai-capture-gateway/vault
...
```bash
rsync -av --exclude node_modules --exclude .git /Users/x/Developer/obsidian-ai-capture-gateway/ user@your-vps:/opt/vaultecho/
```
